...
class ServiceMonitor
{
    ...
    public function RunNotifactions()
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            if ($data['panel']['inboundstatus'] == "oninbounddisable" && ($data['panel']['type'] == "marzban" || $data['panel']['type'] == "rebecca")) $this->active_inbound_expire($data['invoice'],  $data['userData'], $data['panel']);
        }
    }
    ...
    private function shouldRemoveServiceـvolume($invoice, $user, $userData, $username)
    {
        ...
        if ($panel['type'] != "marzban" && $panel['type'] != "rebecca") return;
